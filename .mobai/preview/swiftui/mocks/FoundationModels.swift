...
public class LanguageModelSession {
    ...
    public struct ResponseStream<Content>: Hashable where Content : Generable {
        public struct Snapshot<Content>: Hashable where Content : Generable {
        ...
        public struct AsyncIterator<Content>: Hashable where Content : Generable {
    ...
    public struct Response<Content>: Hashable where Content : Generable {
